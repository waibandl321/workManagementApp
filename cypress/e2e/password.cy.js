describe('パスワード再設定画面', () => {
    it('画面遷移', () => {
        ...
        cy.get('[data-ut-id="passwordResetEmailSend"]').should('have.attr', 'disabled', 'disabled')
        cy.contains('[data-ut-id="backSigninFromPasswordReset"]', 'サインイン画面に戻る')
    })
    ...
    it('確認メール送信OK', () => {
        ...
        cy.get('[data-ut-id="passwordResetEmailSend"]').should('not.have.attr', 'disabled')
        cy.get('[data-ut-id="passwordResetEmailSend"]').click()
        cy.wait(2000)
        // successメッセージ
